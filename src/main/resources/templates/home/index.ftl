...
<#-- 轮播css -->
    <link href="${basePath!}/css/home/common/_carousel.css" rel="stylesheet" type="text/css"/>
<#-- 文章列表css -->
...
<#-- 文章列表js -->
    ...
    <script src="${basePath!}/js/home/index.js"></script>
    <title>浩瀚星尘的博客</title>
</head>
<body>
...
<#-- 主体内容部分 -->
    <section class="container pt-sm-3">
        ...
        <#-- 左侧 -->
            ...
            <#-- 首页轮播 -->
                <#include 'common/_carousel.ftl'/>

                <div id="main-list" class="pt-sm-3 rounded">
                    <h4 class="font-weight-bold text-dark">最新文章</h4>
                <#-- 列表标题分隔线 -->
                    <hr class="module-hr">
